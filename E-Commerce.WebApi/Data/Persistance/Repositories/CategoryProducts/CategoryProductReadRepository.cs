...
{
    public class CategoryProductReadRepository : ReadRepository<CategoryProduct>, ICategoryProductReadRepository
    {
        public CategoryProductReadRepository(AppDbContext context) : base(context)
        {
        }
    }
}
